...
public final class CC {
	...
	public static String PRIMARY = String.valueOf(ChatColor.valueOf(Fortune.getInstance().getConfig().getString("MAIN_COLOR")));
	public static String SECONDARY = String.valueOf(ChatColor.valueOf(Fortune.getInstance().getConfig().getString("SECONDARY_COLOR")));
